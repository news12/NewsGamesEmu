        ...
        begin
          ...
          begin
            ...
            begin
              ...
              accPlayer.ID_ACC := strtoint(LoginDB.ID);
              accPlayer.PASS := Trim(FunctionBase.GetString(Login.PASS, 10));
              accPlayer.Numeric := Trim(LoginDB.PASS2);
              for I := 0 to 2 do

                accPlayer.Character[I] := LoadPlayer.LoadCharacter(I).Character[I];
